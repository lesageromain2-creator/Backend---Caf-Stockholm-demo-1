...
const googlePlaceReviewsRoutes = require('./routes/google-place-reviews');
...
app.use(cors({
  origin: function (origin, callback) {
    ...
    if (!origin) {
      if (isProduction) {
        console.log('❌ CORS - Requête sans origin refusée (production)');
        return callback(null, false);
      }
      console.log('✅ CORS - Requête sans origin autorisée (dev)');
...
app.use('/google-place-reviews', googlePlaceReviewsRoutes);
